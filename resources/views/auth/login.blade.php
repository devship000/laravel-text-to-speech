                        ...
                        <div class="tab" id="tab-2">
                            <div class="inner-box">
                                ...
                                <form action="{{ route('register') }}" method="post" class="default-form">
                                    ...
                                    <div class="mb-3">
                                        <label for="ref" class="form-label">Referral by <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="ref" id="ref" readonly="" value="vector" placeholder="Referral Code" required="">
